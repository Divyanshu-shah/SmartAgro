...
<head>
    ...
    <title>New Pest Identification Request</title>
</head>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.08);">
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td align="center">
                                        ...
                                        <h1 style="color: #ffffff; font-size: 22px; margin: 0 0 4px; font-weight: 700;">New Pest Identification Request</h1>
                                        <p style="color: #bbf7d0; font-size: 14px; margin: 0;">SmartAgro Diagnostic Submission</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td style="padding: 28px 24px;">
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 16px;">
                                <tr>
                                    <td style="padding: 14px 16px; background-color: #f8fafc; border-left: 4px solid #06b6d4; border-radius: 6px;">
                                        <p style="margin: 0 0 2px; font-size: 11px; text-transform: uppercase; letter-spacing: 1px; color: #6b7280; font-weight: 600;">Farm Size</p>
                                        <p style="margin: 0; font-size: 16px; color: #1f2937;">{{ $farmSize }} acres</p>
                                    </td>
                                </tr>
                            </table>
                            @endif
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 16px;">
                                <tr>
                                    <td style="padding: 14px 16px; background-color: #f8fafc; border-left: 4px solid #8b5cf6; border-radius: 6px;">
                                        <p style="margin: 0 0 2px; font-size: 11px; text-transform: uppercase; letter-spacing: 1px; color: #6b7280; font-weight: 600;">Crop Category</p>
                                        <p style="margin: 0; font-size: 16px; color: #1f2937; font-weight: 500;">{{ ucfirst(str_replace('-', ' ', $cropType)) }}</p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 16px;">
                                <tr>
                                    <td style="padding: 16px; background-color: #fef2f2; border: 1px solid #fecaca; border-radius: 8px;">
                                        <p style="margin: 0 0 6px; font-size: 11px; text-transform: uppercase; letter-spacing: 1px; color: #6b7280; font-weight: 600;">🐛 Pest/Issue Description</p>
                                        <p style="margin: 0; font-size: 15px; color: #374151; line-height: 1.7; white-space: pre-wrap;">{{ $pestProblem }}</p>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 16px;">
                                <tr>
                                    <td style="padding: 16px; background-color: #fffbeb; border: 1px solid #fde68a; border-radius: 8px;">
                                        <p style="margin: 0 0 6px; font-size: 11px; text-transform: uppercase; letter-spacing: 1px; color: #6b7280; font-weight: 600;">🌿 Visible Symptoms</p>
                                        <p style="margin: 0; font-size: 15px; color: #374151; line-height: 1.7; white-space: pre-wrap;">{{ $symptoms }}</p>
                                    </td>
                                </tr>
                            </table>

                            <!-- Pesticide Used (conditional) -->
                            @if($pesticideUsed)
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin-bottom: 16px;">
                                <tr>
                                    <td style="padding: 14px 16px; background-color: #f8fafc; border-left: 4px solid #ec4899; border-radius: 6px;">
                                        <p style="margin: 0 0 2px; font-size: 11px; text-transform: uppercase; letter-spacing: 1px; color: #6b7280; font-weight: 600;">Chemicals Previously Applied</p>
                                        <p style="margin: 0; font-size: 16px; color: #1f2937;">{{ $pesticideUsed }}</p>
                                    </td>
                                </tr>
                            </table>
                            @endif
                            ...
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding: 16px; background-color: #f0fdf4; border: 1px solid #dcfce7; border-radius: 8px; text-align: center;">
                                        <p style="margin: 0; font-size: 14px; color: #166534; font-weight: 600;">📎 {{ count($imagePaths) }} field photo(s) attached to this email</p>
                                    </td>
                                </tr>
                            </table>
                            @endif
                    ...
                    <tr>
                        <td style="padding: 20px 24px; background-color: #f9fafb; border-top: 1px solid #e5e7eb; text-align: center;">
                            <p style="margin: 0; font-size: 12px; color: #9ca3af;">This email was sent from the SmartAgro pest identification form.</p>
